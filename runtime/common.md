...
- Completed checkpoint state is durable; conversation state is disposable. Summarize useful facts and discard raw worker dialogue. Use fresh bounded contexts when practical; never claim a host actually isolated or evicted context unless it did.
